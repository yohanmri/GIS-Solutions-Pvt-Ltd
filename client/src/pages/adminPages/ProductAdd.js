...
export default function AdminProductAdd() {
  ...
  const [formData, setFormData] = useState({
    ...
    category: 'ArcGIS Products',
    price: '',
    stock: '',
    features: '',
    specifications: '',
    license: { type: 'N/A', duration: '', users: '' },
    description: '',
    image: ''
  });
  ...
  const categories = {
    'Software': ['ArcGIS Products', 'QGIS Extensions', 'Custom GIS Applications', 'Mobile GIS Apps', 'Web GIS Platforms'],
    'Hardware': ['GPS Devices', 'Survey Equipment', 'Drones & UAV', 'Tablets & Handhelds', 'Total Stations'],
    'Data & Maps': ['Satellite Imagery', 'Topographic Data', 'Custom Maps', 'LiDAR Data', 'Aerial Photography'],
    'Training & Certification': ['ArcGIS Training', 'QGIS Training', 'Remote Sensing Training', 'GPS Training', 'Certification Programs'],
    'Service': ['Mapping & Surveying', 'Spatial Analysis', 'GIS Consulting', 'Custom Development', 'Data Processing', 'System Integration']
  };
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => {
                      ...
                      handleChange('productType', newType);
                      // Reset category when product type changes
                      handleChange('category', categories[newType][0]);
                    }}
                    style={{
                      width: '100%',
                      padding: '8px 12px',
                ...
                <calcite-label>
                  ...
                  <calcite-text-area
                    ...
                    placeholder="e.g., Cloud-based, Real-time collaboration, Advanced analytics"
                    rows="3"
                  />
                </calcite-label>
                ...
                <calcite-label>
                  ...
                  <calcite-text-area
                    ...
                    onInput={(e) => handleChange('specifications', e.target.value)}
                    placeholder="e.g., System requirements, compatibility, technical details..."
                    rows="3"
                  />
                </calcite-label>
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => handleChange('license', { ...formData.license, type: e.target.value })}
                    style={{
                      width: '100%',
                      padding: '8px 12px',
                      fontSize: '14px',
                  ...
                  {formData.license.type !== 'N/A' && (
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px' }}>
                      <calcite-label>
                        Duration
                        <calcite-input-text
                          value={formData.license.duration}
                          onInput={(e) => handleChange('license', { ...formData.license, duration: e.target.value })}
                      ...
                      <calcite-label>
                        Users
                        <calcite-input-number
                          value={formData.license.users}
                          onInput={(e) => handleChange('license', { ...formData.license, users: e.target.value })}
