...
export default function AdminBundleList() {
  ...
  const filterSolutionTypes = ['all', ...solutionTypes];

  const filteredBundles = useMemo(() => {
    return bundles.filter(bundle => {
      const matchesSolutionType = selectedCategory === 'all' || bundle.solutionType === selectedCategory;
      const matchesSearch = bundle.name.toLowerCase().includes(searchQuery.toLowerCase()) ||
        bundle.solutionType?.toLowerCase().includes(searchQuery.toLowerCase());
      return matchesSolutionType && matchesSearch;
    });
  ...
  const handleSaveEdit = async () => {
    try {
      const updateData = {
        ...
        solutionType: selectedBundle.solutionType,
  ...
  const handleSolutionTypeChange = (e) => {
    ...
    setSelectedBundle(prev => ({ ...prev, solutionType: newValue }));
  };
  ...
  return (
    <calcite-shell>
      ...
      <div style={{ padding: '24px', height: '100%', overflow: 'auto' }}>
        <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
          <div style={{
            ...
            <div>
              ...
              <p style={{ margin: 0, fontSize: '14px', color: 'var(--calcite-ui-text-3)' }}>
                Manage GIS solution packages and offerings
              </p>
            </div>
            {canCreate('bundles') && (
              <calcite-button
          ...
          <div style={{
            ...
            <calcite-input
              type="text"
              placeholder="Search solution packages..."
              value={searchQuery}
          ...
          <div style={{ marginBottom: '16px' }}>
            <calcite-chip>{filteredBundles.length} solution packages</calcite-chip>
          </div>
            ...
            <div style={{
              ...
              {filteredBundles.map(bundle => (
                ...
                >
                  ...
                  <span slot="description">{bundle.solutionType}</span>
              ...
              {filteredBundles.map((bundle, index) => (
                <div
                  ...
                  style={{
                    ...
                    padding: '16px',
                    cursor: 'pointer',
                    borderBottom: index !== filteredBundles.length - 1 ? '1px solid #f1f5f9' : 'none',
                ...
                >
                  ...
                  <div style={{ flex: 1 }}>
                    <div style={{ fontWeight: '600', fontSize: '16px', marginBottom: '4px' }}>
                      {bundle.name || 'Unnamed Package'}
                    </div>
                    <div style={{ fontSize: '14px', color: '#6b7280' }}>
                      {bundle.solutionType || 'N/A'} • {(bundle.quantity || 0)} items • {calculateDiscount(bundle.originalPrice, bundle.discountPrice)}% OFF
                    </div>
                  </div>
                  <div style={{
                    display: 'flex',
          ...
          {!loading && filteredBundles.length === 0 && (
            <calcite-notice open icon="exclamation-mark-triangle" kind="warning">
              <div slot="title">No solution packages found</div>
      ...
      <calcite-modal
        ...
        width-scale="l"
      >
        <div slot="header">Edit Solution Package</div>
          ...
          {selectedBundle && (
            <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              ...
              <div>
                ...
                <select
                  value={selectedBundle.solutionType}
