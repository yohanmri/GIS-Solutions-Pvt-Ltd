...
export default function AdminBundleAdd() {
  ...
  const validateForm = () => {
    ...
    if (!formData.name.trim()) {
      setError('Solution package name is required');
      return false;
    }
    ...
    if (!formData.image) {
      setError('Please upload a solution package image');
      return false;
    }
    return true;
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(err.response?.data?.message || 'Failed to create solution package. Please try again.');
    } finally {
      setLoading(false);
    }
  };
        ...
        <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
          <div style={{ marginBottom: '24px' }}>
            ...
            <p style={{ margin: 0, fontSize: '14px', color: 'var(--calcite-ui-text-3)' }}>
              Create a new GIS solution package offering
            </p>
            <calcite-button
              appearance="outline"
              scale="s"
          ...
          {success && (
            <calcite-notice open icon="check-circle" kind="success" style={{ marginBottom: '20px' }}>
              ...
              <div slot="message">Solution package created successfully. Redirecting...</div>
            </calcite-notice>
          )}
          ...
          <form onSubmit={handleSubmit}>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '24px' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                <calcite-label>
                  ...
                  <calcite-input-text
                    ...
                    placeholder="e.g., Urban Planning Complete Solution"
                    required
                  />
                </calcite-label>
              ...
              <div>
                <calcite-label>Solution Package Image *</calcite-label>
                  ...
                  {!formData.image ? (
                    ...
                    >
                      ...
                      <p style={{ margin: '0 0 8px 0', fontWeight: '600' }}>
                        Click to upload solution package image
                      </p>
                      <p style={{ margin: 0, fontSize: '14px', color: 'var(--calcite-ui-text-3)' }}>
                        PNG, JPG up to 5MB
                      </p>
            ...
            <div style={{
              ...
              <calcite-button
                ...
                style={{ flex: 1 }}
              >
                {loading ? 'Creating Solution Package...' : 'Create Solution Package'}
              </calcite-button>
              <calcite-button
                appearance="outline"
                onClick={handleReset}
