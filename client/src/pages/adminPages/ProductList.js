...
export default function AdminProductList() {
  ...
  const handleProductTypeChange = (e) => {
    const newValue = e.target.value;
    setSelectedProduct(prev => ({ ...prev, productType: newValue }));
  };
              ...
              {filteredProducts.map(product => (
                ...
                >
                  ...
                  <div className="product-features">
                    {product.license?.type && product.license.type !== 'N/A' && (
                      <div className="license-indicator-chip">
                        <span>📄 {product.license.type}</span>
                      </div>
                    )}
                  </div>
