...
export default function AdminBundleDetail() {
  ...
  const handleSolutionTypeChange = (e) => {
    setSelectedBundle({ ...selectedBundle, solutionType: e.target.value });
  };
  ...
  return (
    <calcite-shell>
      ...
      <div style={{ padding: '24px', height: '100%', overflow: 'auto' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
            ...
            <div style={{
              ...
              <div>
                ...
                <div style={{ display: 'flex', gap: '8px', alignItems: 'center', flexWrap: 'wrap' }}>
                  <calcite-chip appearance="solid">{bundle.solutionType}</calcite-chip>
          ...
          <div style={{
            ...
            {/* Left Column - Image */}
            <calcite-card>
              <div slot="heading">Solution Package Image</div>
              <img
                src={bundle.image}
                alt={bundle.name}
                style={{
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
              ...
              {/* Bundle Info */}
              <calcite-card>
                <div slot="heading">Solution Package Information</div>
                <div style={{ padding: '20px', display: 'flex', flexDirection: 'column', gap: '16px' }}>
                  <div>
                    ...
                    <p style={{ margin: 0, fontSize: '16px' }}>{bundle.solutionType}</p>
                  </div>
      ...
      <calcite-modal
        ...
        width-scale="s"
      >
        <div slot="header">Delete Solution Package</div>
        <div slot="content" style={{ padding: '20px' }}>
          <calcite-notice open icon="exclamation-mark-triangle" kind="danger">
